         ...
         <div className='container'>
           <div className='flex items-center justify-between'>
               <div>
                 ...
                 <h1 className='details'>E-Commerce Frontend</h1>
                 <Paragraph paratext=" the frontend code for an eCommerce website. It is likely built using modern web technologies such as React.js, HTML, CSS, and JavaScript. The project provides a user-friendly interface for browsing products, managing carts, and making purchases. It is designed to work with a backend for a complete online shopping experience." paraclass="mt-[30px] w-[420px] leading-[35px] text-justify" />
