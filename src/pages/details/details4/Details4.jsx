    ...
    <div className='container'>
      <div className='flex items-center justify-between'>
          <div>
            ...
            <h1 className='details'>Finsweet</h1>
            <Paragraph paratext=" This GitHub repository contains a React-based web application project. It is likely built using React.js along with other modern frontend technologies such as HTML, CSS, and JavaScript. The project may include components, state management, and routing to create an interactive user interface. It serves as a foundation for building scalable and dynamic web applications." paraclass="mt-[30px] w-[420px] leading-[35px] text-justify" />
