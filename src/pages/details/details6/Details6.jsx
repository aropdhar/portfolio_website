    ...
    <div className='container'>
      <div className='flex items-center justify-between'>
          <div>
            ...
            <h1 className='details'>DashBoard</h1>
            <Paragraph paratext="This Netlify link hosts a deployed dashboard project, likely built using modern web technologies like React.js and Tailwind CSS. The dashboard may feature data visualization, task management, or admin panel functionalities. It provides a user-friendly interface with dynamic components for efficient interaction. The project is accessible online, ensuring real-time updates and responsiveness." paraclass="mt-[30px] w-[420px] leading-[35px] text-justify" />
