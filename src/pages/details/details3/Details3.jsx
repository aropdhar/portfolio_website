...
import banner from '../../../assets/project2.png'
         ...
         <div className='container'>
           <div className='flex items-center justify-between'>
               <div>
                 ...
                 <h1 className='details'>E-Commerce Backend</h1>
                 <Paragraph paratext=" This GitHub repository contains the backend code for an eCommerce website. It likely includes APIs for user authentication, product management, order processing, and payment integration. Built using technologies like Node.js, Express, and a database such as MongoDB or MySQL, it ensures secure and efficient server-side operations. The backend connects with the frontend to provide a seamless shopping experience." paraclass="mt-[30px] w-[420px] leading-[35px] text-justify" />
