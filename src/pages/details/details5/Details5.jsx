    ...
    <div className='container'>
      <div className='flex items-center justify-between'>
          <div>
            ...
            <h1 className='details'>E-Learning</h1>
            <Paragraph paratext="E-learning platforms built with React.js and Tailwind CSS offer a fast, responsive, and interactive user experience. React.js ensures smooth component-based development, making the platform scalable and dynamic. Tailwind CSS provides utility-first styling, allowing for a clean and modern design with minimal effort. Together, these technologies help create an engaging online learning environment with seamless navigation and performance." paraclass="mt-[30px] w-[420px] leading-[35px] text-justify" />
